...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2023 at 08:49 AM
...
INSERT INTO `users` (`id`, `nama_lengkap`, `username`, `password`, `email`, `role_id`) VALUES
(1, 'Fakhirul Akmal', 'fakhirula', 'fakhirul', 'fakhirul@yahoo.com', 2),
(2, 'Muhammad Sumbul', 'sumbul', 'sumbul123', 'sumbul@netscape.com', 2),
(3, 'Ica Ajah', 'icaica', 'ica123', 'ica@rocket.mail.com', 1);
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
